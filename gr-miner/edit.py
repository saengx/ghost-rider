...
def OffMiner():
   ...
   try:
       print("ตัวอย่าง:")
       print(" \033[92mstratum+tcp://asia-west.raptoreum.zone:4010\033[00m")
       print(" \033[92mstratum+tcp://stratum+tcp://ghostrider.sea.mine.zpool.ca:5354\033[00m")
       pool = input(" pool : ")
       print("\033[35m-----------------------------------------\033[0m")
        
       print("ตัวอย่าง: \033[92mRSdqb433ZCShkPVTr8KSba5V62RptTHbAs\033[00m")
       wallet = input("wallet: ")
       print("\033[35m-----------------------------------------\033[0m")
